...
> "Audit this generated GLB and show whether its parts are usable." → `evaluate asset.glb --audit --frames --render`, then inspect `report.html`, `REPORT.md`, `reports/parts.json`, and the overview/structure/part evidence frames.
