...
1. **Have one or more generated/third-party GLBs and need to know if they are usable?** → `evaluate a.glb b.glb --frames --render` writes per-asset quality reports, heuristic scores, a standardized comparison scene, optional evidence frames, optional MP4, and `REPORT.md`. **This is the default for AI-generated GLBs.**
